...
my_data = pd.read_csv("classes/proofs/training_individual.csv")
...
for n in range(1,6):
    if n ==1:
        target = ["thumbStatus"]
        predictors = ['thumb1x','thumb1y','thumb1z','thumb2x','thumb2y','thumb2z','thumb3x','thumb3y','thumb3z']
    elif n==2:
        target = ["indexStatus"]
        predictors = ['index1x','index1y','index1z','index2x','index2y','index2z','index3x','index3y','index3z']
    elif n==3:
        target = ["middleStatus"]
        predictors = ['middle1x','middle1y','middle1z','middle2x','middle2y','middle2z','middle3x','middle3y','middle3z']
    elif n==4:
        target = ["ringStatus"]
        predictors = ['ring1x','ring1y','ring1z','ring2x','ring2y','ring2z','ring3x','ring3y','ring3z']
    elif n==5:
        target = ["pinkyStatus"]
        predictors = ['pinky1x','pinky1y','pinky1z','pinky2x','pinky2y','pinky2z','pinky3x','pinky3y','pinky3z']
    ...
    while 1:
        ...
        mlp = MLPClassifier(hidden_layer_sizes=(45,500,250,1), solver='lbfgs', max_iter=50000)
        ...
        if cont.lower() == "y":
            ...
            joblib.dump(mlp, f"gesture_classifier_0{n}")
            break
        elif cont.lower() =="skip":
            break
        else:
